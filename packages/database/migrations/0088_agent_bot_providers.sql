...
ALTER TABLE "agent_bot_providers" DROP CONSTRAINT IF EXISTS "agent_bot_providers_agent_id_agents_id_fk";
...
ALTER TABLE "agent_bot_providers" DROP CONSTRAINT IF EXISTS "agent_bot_providers_user_id_users_id_fk";
...
CREATE INDEX IF NOT EXISTS "agent_bot_providers_user_id_idx" ON "agent_bot_providers" USING btree ("user_id");
